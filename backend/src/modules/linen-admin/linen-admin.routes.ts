...
linenAdminRouter.post('/admin/linen/writeoff', requireAnyPermission(['operations', 'edit'], ['inventory', 'edit']), asyncHandler(linenAdminController.writeoff));
linenAdminRouter.get('/admin/linen/writeoffs', requireAnyPermission(['operations', 'view'], ['inventory', 'view']), asyncHandler(linenAdminController.writeoffs));
