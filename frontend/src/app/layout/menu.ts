...
export const RECEPCION_MENU: MenuItem[] = [
  ...
  { label: 'Folios', icon: 'pi pi-folder', route: '/operations/folios' },
...
export const ADMIN_MENU: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Historial de Estancias', route: '/operations/estancias' },
      { label: 'Folios de Estancia', route: '/operations/folios' },
      { label: 'Folios Maestros (Empresas)', route: '/operations/folios-maestros' },
